  ...
  },
  {
    ...
    steps: {
      fr: [
        ...
        "Ce qu'il ne sait pas (encore) faire depuis Teams\nL'expérience Copilot dans Teams est volontairement resserrée. Deux absences à connaître :\n➞ Pas de Notebooks : les carnets Copilot ne sont pas disponibles ici.\n➞ Pas de Create : l'espace de génération (images, pages) n'y est pas non plus.\nL'usage se concentre donc sur les chats et les agents. Pour les Notebooks ou Create, passez par l'application Copilot dédiée ou par le web. Mais pour interroger Copilot au fil de la journée, l'avoir dans Teams reste le réflexe le plus pratique.",
      ...
      en: [
        ...
        "What it can't (yet) do from Teams\nThe Copilot experience in Teams is deliberately trimmed down. Two absences to know about :\n➞ No Notebooks: Copilot notebooks aren't available here.\n➞ No Create: the generation space (images, pages) isn't here either.\nSo usage focuses on chats and agents. For Notebooks or Create, use the dedicated Copilot app or the web. But to query Copilot throughout the day, having it in Teams remains the handiest reflex.",
