...
export const tips: Tip[] = [
  ...
  {
    slug: "cowork-veille-mensuelle-whats-new",
    leadTitles: true,
    section: "m365",
    audience: ["user", "it"],
    product: "cowork",
    roles: ["Manager", "Consultant", "IT Admin", "Marketing"],
    level: "advanced",
    icon: "/cowork.png",
    date: "2026-07-21",
    isNew: true,
    ...
    readMinutes: 7,
    title: {
      fr: "Automatiser sa veille Copilot : un « What's New » mensuel généré et envoyé par Cowork",
      en: "Automate your Copilot watch: a monthly « What's New » generated and sent by Cowork",
    },
    summary: {
      fr: "Le vrai super-pouvoir de Cowork, c'est de tenir une mission récurrente à votre place. Voici un prompt prêt à planifier qui, chaque mois, lit l'article « What's New in Microsoft 365 Copilot » sur le Microsoft Community Hub, en produit un résumé structuré, puis l'envoie par email dans une mise en page chartée et le publie dans vos canaux Teams.",
      en: "Cowork's real superpower is running a recurring mission for you. Here's a ready-to-schedule prompt that, every month, reads the « What's New in Microsoft 365 Copilot » article on the Microsoft Community Hub, produces a structured summary, then emails it in a branded layout and posts it to your Teams channels.",
    },
    steps: {
      fr: [
        "L'idée : déléguer une veille récurrente\nTout le monde veut rester à jour sur les nouveautés Copilot, mais personne n'a le temps de lire le blog chaque mois, de trier, de résumer puis de diffuser. C'est exactement le genre de mission répétitive et à étapes que Cowork sait tenir tout seul.\nLe principe est simple : vous écrivez le prompt une seule fois, vous le planifiez pour qu'il s'exécute tous les mois, et Cowork fait le travail (vérifier, résumer, mettre en forme, envoyer). Vous ne touchez plus à rien.",
        "Cowork travaille sous vos yeux\nPendant qu'il exécute la mission, Cowork reste transparent. Dans le Workspace, vous voyez tout : en entrée, la tâche planifiée et sa fréquence ; en sortie, le fichier généré (ici l'email HTML) ; et les compétences que Cowork mobilise à chaque étape.\nVous gardez donc la main : ouvrir la sortie, relancer la tâche manuellement ou ajuster la planification, à tout moment.",
        "Ce que le prompt demande à Cowork\nLe prompt à copier plus bas décrit une mission complète et cadrée :\n➞ Aller sur le blog Microsoft 365 Copilot du Microsoft Community Hub.\n➞ Vérifier si l'édition récapitulative du mois en cours, « What's New in Microsoft 365 Copilot | [Mois] [Année] », est publiée (elles sortent en fin de mois).\n➞ Ne pas la confondre avec une annonce de fonctionnalité isolée ou un article Copilot Studio.\n➞ Si l'édition du mois est déjà diffusée, s'arrêter. Si elle n'est pas encore publiée, ne rien envoyer et réessayer à la prochaine exécution.",
        "Un résumé structuré et reformulé\nQuand l'article est disponible, Cowork récupère tout le contenu, l'analyse et en produit un résumé concis en anglais, reformulé avec ses propres mots et jamais copié mot pour mot.\nLe résumé est rangé en deux familles, ce qui le rend directement exploitable :\n➞ User Capabilities : les nouveautés pour les utilisateurs métiers.\n➞ IT Admin Capabilities : ce qui concerne l'IT, la sécurité, la conformité et la gouvernance.\nChaque ligne suit le même format court : « Nom : description en une phrase ».",
        "La diffusion : un email HTML mis en forme\nC'est là que Cowork brille : il ne se contente pas de résumer, il met en forme. Il génère un email HTML professionnel, compatible avec les principaux clients de messagerie et aux couleurs de votre organisation.\nEn-tête avec bandeau or, titre « What's New in Microsoft 365 Copilot » et sous-titre « Édition [Mois] [Année] », une phrase d'introduction, puis les deux sections (User et IT Admin), un bouton « Read the full [Month] [Year] update » qui pointe vers l'article source, et un pied de page avec le lien, le rédacteur et l'organisation.\nCi-dessous, le rendu réel obtenu pour l'édition de juin 2026.",
        "Et aussi dans Teams\nLe même résumé est publié dans deux espaces Teams pour toucher vos relais :\n➞ Le canal « Microsoft 365 Copilot News » de l'équipe « Digital Workplace » (le format texte suffit).\n➞ La conversation de groupe « Copilot Champions Network », que Cowork retrouve automatiquement par son nom avant de publier.\nUn seul prompt, trois canaux : le mail pour la diffusion large, Teams pour vos communautés.",
        "La gestion des doublons et la planification\nPour ne jamais envoyer deux fois la même édition, le prompt demande à Cowork d'enregistrer le mois et l'année une fois la diffusion réussie, puis de reprendre la surveillance pour l'édition suivante.\nCôté planification : lancez la mission une première fois pour valider le rendu, puis planifiez son exécution récurrente (par exemple les derniers jours du mois). Comme les éditions sortent en fin de mois, Cowork tombe au bon moment. Et s'il ne trouve rien, il attend simplement la prochaine exécution.",
        "Ce qu'il faut retenir\nUn bon prompt Cowork planifié, c'est une tâche de veille entière qui disparaît de votre charge mentale. Vous cadrez la mission une fois (quoi chercher, comment résumer, où diffuser, comment éviter les doublons), et vous récupérez chaque mois une communication prête à l'emploi, chartée et multi-canal.\nLe même schéma se réplique pour toute veille récurrente : roadmap, Message Center, blog d'un produit. Copiez le prompt, adaptez la source et les destinataires, planifiez, et laissez Cowork tenir le rythme.",
      ],
      en: [
        "The idea: delegate a recurring watch\nEveryone wants to stay up to date on Copilot news, but nobody has time to read the blog every month, sort it, summarize it and share it. That's exactly the kind of repetitive, multi-step mission Cowork can run on its own.\nThe principle is simple: you write the prompt once, you schedule it to run every month, and Cowork does the work (check, summarize, format, send). You never touch it again.",
        "Cowork works in plain sight\nWhile it runs the mission, Cowork stays transparent. In the Workspace you see everything: the scheduled task and its frequency as the input; the generated file as the output (here the HTML email); and the skills Cowork uses at each step.\nSo you keep control: open the output, run the task manually, or adjust the schedule at any time.",
        "What the prompt asks Cowork to do\nThe prompt to copy below describes a complete, framed mission:\n➞ Go to the Microsoft 365 Copilot blog on the Microsoft Community Hub.\n➞ Check whether the current month's recap edition, « What's New in Microsoft 365 Copilot | [Month] [Year] », is published (they ship at month's end).\n➞ Do not confuse it with a single-feature announcement or a Copilot Studio article.\n➞ If this month's edition was already sent, stop. If it isn't published yet, send nothing and retry on the next run.",
        "A structured, reworded summary\nWhen the article is available, Cowork grabs all the content, analyzes it and produces a concise summary in English, reworded in its own words and never copied verbatim.\nThe summary is sorted into two families, which makes it immediately usable:\n➞ User Capabilities: the news for business users.\n➞ IT Admin Capabilities: what concerns IT, security, compliance and governance.\nEach line follows the same short format: « Name: one-sentence description ».",
        "Distribution: a formatted HTML email\nThis is where Cowork shines: it doesn't just summarize, it formats. It generates a professional HTML email, compatible with the main mail clients and in your organization's colors.\nA header with a gold band, the title « What's New in Microsoft 365 Copilot » and the subtitle « Édition [Month] [Year] », an intro line, then the two sections (User and IT Admin), a « Read the full [Month] [Year] update » button pointing to the source article, and a footer with the link, the author and the organization.\nBelow is the actual rendering produced for the June 2026 edition.",
        "And in Teams too\nThe same summary is posted to two Teams spaces to reach your relays:\n➞ The « Microsoft 365 Copilot News » channel of the « Digital Workplace » team (plain text is enough).\n➞ The « Copilot Champions Network » group chat, which Cowork finds automatically by name before posting.\nOne prompt, three channels: email for broad reach, Teams for your communities.",
        "Duplicate handling and scheduling\nSo the same edition is never sent twice, the prompt asks Cowork to record the month and year once distribution succeeds, then resume watching for the next edition.\nOn scheduling: run the mission once to validate the output, then schedule it to run on a recurring basis (for example on the last days of each month). Since editions ship at month's end, Cowork lands at the right time. And if it finds nothing, it simply waits for the next run.",
        "What to remember\nA well-crafted, scheduled Cowork prompt is an entire watch task that disappears from your mental load. You frame the mission once (what to look for, how to summarize, where to distribute, how to avoid duplicates), and every month you get a ready-to-use, branded, multi-channel communication.\nThe same pattern works for any recurring watch: roadmap, Message Center, a product blog. Copy the prompt, adapt the source and recipients, schedule it, and let Cowork keep the rhythm.",
      ],
    },
    stepImages: [
      null,
      "/articles/cowork-whats-new-schedule-workspace.png",
      null,
      null,
      "/articles/cowork-whats-new-email.png",
      null,
      [
        "/articles/cowork-whats-new-schedule-task.png",
        "/articles/cowork-whats-new-schedule-manage.png",
      ],
      null,
    ],
    imageWidth: "md",
    imageCaptions: [
      { step: 1, text: { fr: "Le Workspace de Cowork : en entrée la tâche planifiée, en sortie le fichier généré, et les compétences mobilisées.", en: "Cowork's Workspace: the scheduled task as input, the generated file as output, and the skills it uses." } },
      { step: 4, text: { fr: "Le rendu réel généré par Cowork : l'email HTML charté de l'édition de juin 2026, prêt à envoyer.", en: "The actual rendering generated by Cowork: the branded HTML email for the June 2026 edition, ready to send." } },
      { step: 6, text: { fr: "La mission planifiée dans Cowork : exécution mensuelle récurrente et instructions détaillées.", en: "The scheduled mission in Cowork: recurring monthly run and detailed instructions." } },
    ],
    info: {
      fr: "Cowork nécessite une licence Microsoft 365 Copilot ET une billing policy activée (paiement à l'usage / PAYGO) pour fonctionner : les missions agentiques consomment des crédits facturés à l'usage. La planification récurrente et l'accès à vos canaux Teams / votre messagerie dépendent aussi des capacités activées dans votre environnement. Renseignez-vous auprès de votre IT.",
      en: "Cowork requires a Microsoft 365 Copilot license AND an enabled billing policy (pay-as-you-go / PAYGO) to work: agentic missions consume pay-as-you-go metered credits. Recurring scheduling and access to your Teams channels / mailbox also depend on the capabilities enabled in your environment. Check with your IT.",
    },
    prompt: {
      fr: "Chaque mois, vérifie si l'édition du mois en cours de l'article « What's New in Microsoft 365 Copilot | [Mois] [Année] » a été publiée sur le blog Microsoft 365 Copilot du Microsoft Community Hub.\n\nRègles de validation :\n➞ Ne retiens que l'édition récapitulative mensuelle (pas les annonces d'une seule fonctionnalité, pas les articles spécifiques à un produit, pas Copilot Studio).\n➞ Si l'édition du mois a déjà été diffusée, arrête-toi immédiatement.\n➞ Si elle n'est pas encore publiée, ne diffuse rien, note qu'aucune publication n'a été trouvée, et refais la vérification à la prochaine exécution planifiée.\n\nQuand l'article est disponible :\n1) Récupère l'intégralité de son contenu et analyse les nouveautés.\n2) Produis un résumé concis en anglais, reformulé avec tes propres mots, sans jamais copier le texte mot pour mot.\n3) Structure-le en deux catégories, chaque ligne au format « Nom : description en une ligne » :\n   • User Capabilities : fonctionnalités pour les utilisateurs métiers.\n   • IT Admin Capabilities : admin, IT, sécurité, conformité et gouvernance.\n\nDiffusion (3 canaux) :\n1) Email HTML professionnel, compatible avec les principaux clients de messagerie. Objet : « What's New in Microsoft 365 Copilot | [Mois] [Année] ». Charte : or #B4884D, bleu #0F6CBD, orange #C7420A. Structure : bandeau supérieur or sur fond blanc, titre « What's New in Microsoft 365 Copilot », sous-titre « Édition [Mois] [Année] », une phrase d'introduction, section « User Capabilities », section « IT Admin Capabilities », bouton « Read the full [Month] [Year] update » pointant vers l'article source, pied de page (lien vers l'article, nom du rédacteur, nom de l'organisation). Destinataires : la liste de diffusion configurée.\n2) Canal Teams « Microsoft 365 Copilot News » de l'équipe « Digital Workplace » : même résumé, format texte, titre « What's New in Microsoft 365 Copilot | [Mois] [Année] ».\n3) Conversation de groupe Teams « Copilot Champions Network » (recherche-la automatiquement par son nom avant de publier) : même résumé, même titre.\n\nGestion des doublons : après une diffusion réussie, enregistre le mois et l'année comme déjà diffusés, empêche tout nouvel envoi de cette édition, puis reprends la surveillance pour l'édition du mois suivant.",
      en: "Every month, check whether the current month's edition of the article « What's New in Microsoft 365 Copilot | [Month] [Year] » has been published on the Microsoft 365 Copilot blog on the Microsoft Community Hub.\n\nValidation rules:\n➞ Only consider the monthly recap edition (not single-feature announcements, not product-specific posts, not Copilot Studio).\n➞ If this month's edition has already been distributed, stop immediately.\n➞ If it isn't published yet, distribute nothing, note that no publication was found, and check again on the next scheduled run.\n\nWhen the article is available:\n1) Retrieve its full content and analyze the new features.\n2) Produce a concise summary in English, reworded in your own words, without ever copying the text verbatim.\n3) Structure it into two categories, each line formatted as « Name: one-line description »:\n   • User Capabilities: features for business users.\n   • IT Admin Capabilities: admin, IT, security, compliance and governance.\n\nDistribution (3 channels):\n1) Professional HTML email, compatible with the main mail clients. Subject: « What's New in Microsoft 365 Copilot | [Month] [Year] ». Palette: gold #B4884D, blue #0F6CBD, orange #C7420A. Structure: thin gold top band on white, title « What's New in Microsoft 365 Copilot », subtitle « Édition [Month] [Year] », one intro sentence, « User Capabilities » section, « IT Admin Capabilities » section, a « Read the full [Month] [Year] update » button pointing to the source article, footer (link to the article, author name, organization name). Recipients: the configured distribution list.\n2) Teams channel « Microsoft 365 Copilot News » in the « Digital Workplace » team: same summary, plain text, title « What's New in Microsoft 365 Copilot | [Month] [Year] ».\n3) Teams group chat « Copilot Champions Network » (find it automatically by name before posting): same summary, same title.\n\nDuplicate handling: after a successful distribution, record the month and year as already sent, prevent any new send of that edition, then resume watching for the next month's edition.",
    },
    links: [
      {
        label: { fr: "Blog Microsoft 365 Copilot (Microsoft Community Hub)", en: "Microsoft 365 Copilot blog (Microsoft Community Hub)" },
        url: "https://techcommunity.microsoft.com/category/microsoft365copilot/blog/microsoft365copilotblog",
      },
    ],
    tags: ["cowork", "copilot cowork", "prompt", "veille", "automatisation", "planifié", "email", "teams", "whats new", "avec licence"],
  },
  {
  ...
  {
    slug: "facilitator-agent-reunion-teams",
    leadTitles: true,
    section: "m365",
    audience: ["user"],
    product: "teams",
    ...
    readMinutes: 6,
    title: {
      fr: "Facilitator : l'agent qui prend vos réunions Teams en note à votre place",
      en: "Facilitator: the agent that takes notes in your Teams meetings for you",
    },
    summary: {
      fr: "Facilitator est un agent Copilot qui s'assoit dans vos réunions Teams comme un membre de plus : il prend des notes en temps réel, suit l'agenda, garde le fil des décisions et des tâches, et répond aux questions dans le chat de réunion. On voit comment l'activer (deux façons), ce qu'il fait, et la nuance à ne pas confondre avec la simple transcription automatique.",
      en: "Facilitator is a Copilot agent that sits in your Teams meetings like an extra teammate: it takes notes in real time, tracks the agenda, keeps up with decisions and tasks, and answers questions in the meeting chat. Let's see how to turn it on (two ways), what it does, and the nuance not to confuse with plain automatic transcription.",
    },
    steps: {
      fr: [
        "Un membre d'équipe en plus dans la réunion\nFacilitator, c'est un agent qui participe à votre réunion comme le ferait un collègue chargé du secrétariat. Dès qu'il est activé, il se présente dans le chat de réunion et annonce ce qu'il va faire : prendre des notes, suivre l'agenda, gérer un timer, répondre aux questions.\nUne différence importante avec Copilot : Facilitator est visible de tout le monde. Là où vos échanges avec Copilot restent privés, les notes et les réponses de Facilitator sont partagées avec l'ensemble des participants. C'est un assistant commun à la réunion, pas un assistant personnel.",
        "Première façon de l'activer : l'accès rapide à la création\nLa méthode la plus simple apparaît dès la création de la réunion, dans Outlook comme dans Teams. Au moment où vous activez le bouton « Teams meeting », un bandeau « Facilitator is off for this meeting » s'affiche avec un lien « Turn on ».\nUn clic sur « Turn on » et c'est réglé : Facilitator est activé, et la transcription se lancera automatiquement au début de la réunion (c'est ce transcript qui lui permet de prendre des notes). Bon à savoir : seuls l'organisateur et les présentateurs peuvent l'activer ou le désactiver.",
        "Deuxième façon : dans les options de réunion\nVous pouvez aussi passer par les options complètes de la réunion, elles aussi accessibles depuis Teams et depuis Outlook. Ouvrez les options, allez dans la section « Copilot and other AI », vérifiez que « Allow Copilot and Facilitator » est bien positionné, puis activez le bouton « Facilitator ». Choisissez la langue parlée, et validez.\nLes deux méthodes font exactement la même chose : elles activent Facilitator, qui lance automatiquement la transcription en début de réunion. À vous de choisir la plus rapide selon le contexte.",
        "Ce qu'il fait : des notes de réunion en temps réel\nUne fois lancé, Facilitator rédige des notes structurées au fil de la discussion, dans l'onglet « Notes » de la réunion. Elles sont organisées par thème, éditables par tout le monde, et se complètent en direct pendant que vous parlez.\nRésultat : à la fin de la réunion, le compte rendu est déjà là. Plus besoin de désigner quelqu'un pour tout noter, chacun peut se concentrer sur la conversation.",
        "Il garde le fil : agenda, timer et prochaines étapes\nFacilitator suit aussi le déroulé. Il peut afficher l'agenda, cocher les sujets traités, lancer un minuteur pour cadencer les points, et signaler les prochaines étapes identifiées pendant l'échange.\nSur la barre du haut de la réunion, vous le voyez à l'œuvre : le suivi de la prise de notes et l'identification des sujets s'affichent en direct, avec le temps écoulé.",
        "Il répond dans le chat : décisions, tâches, points ouverts\nPendant la réunion, adressez-vous à lui dans le chat avec @Facilitator. Tapez « @fa » et il apparaît dans les suggestions. Vous pouvez lui demander les points saillants, la liste des sujets ouverts sous forme de tableau, ou encore « What decisions were made? ».\nIl répond à la vue de tous, en citant le contexte de la discussion, et peut transformer un échange en tâche concrète (avec un responsable), prête à être suivie. Des prompts suggérés vous aident à démarrer si vous ne savez pas quoi lui demander.",
        "La nuance à connaître : transcription automatique n'est pas Facilitator\nDans les options de réunion, une autre section existe : « Recording & transcription », avec le réglage « Record and transcribe automatically » (Record and transcribe, Transcribe only, ou Off). Activez-le et l'enregistrement et/ou la transcription démarrent tout seuls au début de la réunion. Attention : ce réglage n'active pas l'agent Facilitator. Pour bien distinguer les deux :\n➞ Transcription automatique : vous obtenez un transcript. Cela permet d'utiliser Copilot dans la réunion (au minimum grâce à ce transcript), mais n'ajoute pas l'agent.\n➞ Facilitator : un agent en plus qui prend les notes, suit l'agenda et anime la réunion, avec son propre bouton d'activation.",
        "Le désactiver quand vous voulez\nBesoin de le couper en cours de route ? Dans « More actions », choisissez « Turn off Facilitator » (ou le lien « Turn off » du bandeau). Il quitte le chat et arrête de prendre des notes.\nÀ noter : couper Facilitator stoppe la prise de notes automatique mais ne supprime pas les notes déjà rédigées, vous les gardez.",
        "Ce qu'il faut retenir\nFacilitator, c'est le secrétaire de séance intelligent de vos réunions Teams : il prend les notes, suit l'agenda, gère le temps et répond dans le chat, le tout partagé avec toute la réunion.\nDeux réflexes pour bien l'utiliser : l'activer d'un clic (en réunion ou dans les options), et ne pas le confondre avec la transcription automatique, qui elle sert surtout à alimenter Copilot. Facilitator est un agent inclus avec la licence Microsoft 365 Copilot, disponible dans les réunions planifiées.",
      ],
      en: [
        "An extra teammate in the meeting\nFacilitator is an agent that joins your meeting like a colleague handling the minutes. As soon as it's turned on, it introduces itself in the meeting chat and announces what it will do: take notes, track the agenda, manage a timer, answer questions.\nAn important difference with Copilot: Facilitator is visible to everyone. Where your exchanges with Copilot stay private, Facilitator's notes and answers are shared with all participants. It's a shared meeting assistant, not a personal one.",
        "First way to turn it on: quick access at creation\nThe simplest method appears as soon as you create the meeting, in Outlook as well as in Teams. The moment you flip the « Teams meeting » toggle, a « Facilitator is off for this meeting » banner shows up with a « Turn on » link.\nOne click on « Turn on » and you're set: Facilitator is enabled, and transcription will start automatically at the beginning of the meeting (that transcript is what lets it take notes). Good to know: only the organizer and presenters can turn it on or off.",
        "Second way: in the meeting options\nYou can also go through the full meeting options, which are available from Teams and from Outlook too. Open the options, go to the « Copilot and other AI » section, check that « Allow Copilot and Facilitator » is set correctly, then flip the « Facilitator » toggle. Pick the spoken language and apply.\nBoth methods do exactly the same thing: they turn on Facilitator, which automatically starts transcription at the beginning of the meeting. Pick whichever is faster in your context.",
        "What it does: real-time meeting notes\nOnce running, Facilitator writes structured notes as the discussion unfolds, in the meeting's « Notes » tab. They're organized by topic, editable by everyone, and fill in live while you talk.\nThe result: by the end of the meeting, the recap is already there. No need to appoint someone to write everything down, everyone can focus on the conversation.",
        "It keeps up: agenda, timer and next steps\nFacilitator also tracks the flow. It can display the agenda, check off covered topics, start a timer to pace the items, and flag the next steps identified during the exchange.\nOn the meeting's top bar, you see it at work: note-taking progress and topic identification show live, with the elapsed time.",
        "It answers in the chat: decisions, tasks, open items\nDuring the meeting, address it in the chat with @Facilitator. Type « @fa » and it appears in the suggestions. You can ask for the highlights, the list of open items as a table, or « What decisions were made? ».\nIt answers in front of everyone, citing the context of the discussion, and can turn an exchange into a concrete task (with an owner), ready to track. Suggested prompts help you get started if you're not sure what to ask.",
        "The nuance to know: automatic transcription isn't Facilitator\nIn the meeting options, another section exists: « Recording & transcription », with the « Record and transcribe automatically » setting (Record and transcribe, Transcribe only, or Off). Turn it on and recording and/or transcription start on their own at the beginning of the meeting. Careful: this setting does not turn on the Facilitator agent. To tell the two apart:\n➞ Automatic transcription: you get a transcript. It lets you use Copilot in the meeting (at least thanks to that transcript), but doesn't add the agent.\n➞ Facilitator: an extra agent that takes notes, tracks the agenda and hosts the meeting, with its own toggle.",
        "Turn it off whenever you want\nNeed to stop it mid-way? In « More actions », choose « Turn off Facilitator » (or the « Turn off » link in the banner). It leaves the chat and stops taking notes.\nNote: turning Facilitator off stops automatic note-taking but doesn't delete the notes already written, you keep them.",
        "What to remember\nFacilitator is the smart minute-taker of your Teams meetings: it takes notes, tracks the agenda, manages time and answers in the chat, all shared with the whole meeting.\nTwo reflexes to use it well: turn it on in one click (in the meeting or in the options), and don't confuse it with automatic transcription, which mostly feeds Copilot. Facilitator is an agent included with the Microsoft 365 Copilot license, available in scheduled meetings.",
      ],
    },
    stepImages: [
      "/articles/facilitator-intro-prompts.png",
      "/articles/facilitator-banner-turnon.png",
      "/articles/facilitator-meeting-options.png",
      "/articles/facilitator-notes.png",
      "/articles/facilitator-agenda-timer.png",
      [
        "/articles/facilitator-mention-chat.png",
        "/articles/facilitator-decision-task.png",
      ],
      "/articles/facilitator-record-transcribe.png",
      "/articles/facilitator-turn-off.png",
      null,
    ],
    imageWidth: "md",
    imageCaptions: [
      { step: 1, text: { fr: "À la création d'une réunion Teams (Outlook ou Teams) : le bandeau « Facilitator is off for this meeting » et son lien « Turn on ».", en: "When creating a Teams meeting (Outlook or Teams): the « Facilitator is off for this meeting » banner and its « Turn on » link." } },
      { step: 2, text: { fr: "L'autre méthode : le bouton Facilitator dans les options de réunion, section « Copilot and other AI ».", en: "The other method: the Facilitator toggle in the meeting options, « Copilot and other AI » section." } },
    ],
    info: {
      fr: "Facilitator est inclus avec la licence Microsoft 365 Copilot et fonctionne uniquement dans les réunions Teams planifiées (pas les appels, les réunions instantanées, les réunions de canal, ni les chats). Les personnes sans licence ne peuvent pas lui adresser de requête mais voient ses notes et ses réponses. Seuls l'organisateur et les présentateurs peuvent l'activer ou le désactiver.",
      en: "Facilitator is included with the Microsoft 365 Copilot license and works only in scheduled Teams meetings (not calls, instant meetings, channel meetings, or chats). People without a license can't prompt it but can see its notes and answers. Only the organizer and presenters can turn it on or off.",
    },
    links: [
      {
        label: { fr: "Facilitator dans les réunions Teams (support Microsoft)", en: "Facilitator in Teams meetings (Microsoft support)" },
        url: "https://support.microsoft.com/en-us/office/facilitator-in-microsoft-teams-meetings",
      },
      {
        label: { fr: "Configurer Facilitator dans Teams (Microsoft Learn)", en: "Set up Facilitator in Teams (Microsoft Learn)" },
        url: "https://learn.microsoft.com/en-us/microsoftteams/facilitator-teams",
      },
    ],
    tags: ["teams", "facilitator", "agent", "réunion", "notes", "transcription", "agenda", "décisions", "avec licence"],
  },
  {
  ...
  },
  {
    ...
    readMinutes: 4,
    title: {
      fr: "Copilot dans Teams : l'épingler et le piloter sans quitter votre outil du quotidien",
      en: "Copilot in Teams: pin it and drive it without leaving your everyday tool",
    },
    summary: {
      fr: "Saviez-vous que vous pouvez utiliser Copilot directement dans Teams, l'application que vous ouvrez déjà toute la journée ? On voit ensemble où le trouver dans le volet gauche, comment l'épingler vous-même si l'IT ne l'a pas fait, ce que vous pouvez y faire (chat et agents), et ses limites du moment.",
      en: "Did you know you can use Copilot right inside Teams, the app you already keep open all day? Let's see where to find it in the left rail, how to pin it yourself if IT hasn't, what you can do with it (chat and agents), and its current limits.",
    },
    steps: {
      fr: [
        "Piloter Copilot depuis l'outil que vous ouvrez déjà toute la journée\nInutile de changer d'application ou d'ouvrir un onglet de navigateur : Copilot est disponible directement dans Teams, là où vous passez le plus clair de votre journée. Vous discutez, vous suivez vos réunions, et au même endroit vous interrogez Copilot.\nCet article vous montre où le trouver, comment l'épingler si besoin, ce que vous pouvez y faire, et ce qu'il ne sait pas encore faire depuis Teams.",
        "Le repérer dans le volet gauche\nRegardez la barre d'icônes tout à gauche de Teams (celle avec Activité, Chat, Calendrier, Appels). Si votre IT a déjà déployé l'application, l'icône Copilot y figure déjà : un clic et vous y êtes.\nSi vous ne la voyez pas, pas de panique. Soit votre organisation ne l'a pas encore épinglée pour tout le monde, soit il faut l'ajouter vous-même. C'est l'objet de l'étape suivante.",
        "L'épingler vous-même en quelques secondes\nSi Copilot n'est pas dans votre volet gauche, ajoutez-le à la main :\n➞ Ouvrez le Store d'applications de Teams (le « + » ou « Applications » dans le volet gauche).\n➞ Recherchez « Copilot ».\n➞ Sur la ligne Copilot, cliquez sur les « ... », puis sur « Pin » (Épingler).\nL'icône Copilot se fixe alors dans votre volet gauche, et elle y restera. Vous n'aurez plus jamais à la rechercher.",
        "Ce que vous pouvez y faire : chat et agents\nUne fois ouvert, Copilot dans Teams vous donne accès à l'essentiel :\n➞ Le chat Copilot, avec la bascule Work (vos données professionnelles si vous avez la licence) et Web (recherche sur le web).\n➞ Vos agents : Researcher, Analyst, ceux publiés par votre organisation et les vôtres. Vous pouvez aussi ouvrir « All agents » ou « Create agent ».\n➞ Les prompts suggérés et l'historique de vos conversations, comme dans l'application Copilot classique.\nEn clair, vous gardez le cœur de l'expérience Copilot sans quitter Teams.",
        "Ce qu'il ne sait pas (encore) faire depuis Teams\nL'expérience Copilot dans Teams est volontairement resserrée. Les absences à connaître :\n➞ Pas de Notebooks : les carnets Copilot ne sont pas disponibles ici.\n➞ Pas de Create : l'espace de génération (images, pages) n'y est pas non plus.\n➞ Pas de Bibliothèque : vous ne retrouvez pas vos contenus et images sauvegardés.\n➞ Pas de Recherche : la recherche Copilot n'est pas accessible depuis Teams.\nL'usage se concentre donc sur les chats et les agents. Pour les Notebooks, Create, la Bibliothèque ou la Recherche, passez par l'application Copilot dédiée ou par le web. Mais pour interroger Copilot au fil de la journée, l'avoir dans Teams reste le réflexe le plus pratique.",
        "Ce qu'il faut retenir\nCopilot dans Teams, c'est Copilot là où vous travaillez déjà. Épinglez l'icône dans le volet gauche (ou vérifiez que l'IT l'a fait), et vous accédez au chat et à vos agents en un clic.\nGardez juste en tête les limites du moment : pas de Notebooks, pas de Create. Pour tout le reste au quotidien, piloter Copilot depuis Teams est souvent le chemin le plus court.",
      ],
      en: [
        "Drive Copilot from the tool you already keep open all day\nNo need to switch apps or open a browser tab: Copilot is available right inside Teams, where you spend most of your day. You chat, you follow your meetings, and in the same place you query Copilot.\nThis article shows you where to find it, how to pin it if needed, what you can do with it, and what it can't do yet from Teams.",
        "Spot it in the left rail\nLook at the icon bar on the far left of Teams (the one with Activity, Chat, Calendar, Calls). If your IT has already deployed the app, the Copilot icon is already there: one click and you're in.\nIf you don't see it, no worries. Either your organization hasn't pinned it for everyone yet, or you need to add it yourself. That's what the next step is about.",
        "Pin it yourself in a few seconds\nIf Copilot isn't in your left rail, add it manually:\n➞ Open the Teams app Store (the « + » or « Apps » in the left rail).\n➞ Search for « Copilot ».\n➞ On the Copilot row, click the « ... », then « Pin ».\nThe Copilot icon then locks into your left rail, and it stays there. You'll never have to search for it again.",
        "What you can do here: chat and agents\nOnce open, Copilot in Teams gives you the essentials :\n➞ The Copilot chat, with the Work toggle (your work data if you have the license) and Web (web search).\n➞ Your agents: Researcher, Analyst, the ones published by your organization and your own. You can also open « All agents » or « Create agent ».\n➞ Suggested prompts and your conversation history, just like in the standalone Copilot app.\nIn short, you keep the heart of the Copilot experience without leaving Teams.",
        "What it can't (yet) do from Teams\nThe Copilot experience in Teams is deliberately trimmed down. The absences to know about :\n➞ No Notebooks: Copilot notebooks aren't available here.\n➞ No Create: the generation space (images, pages) isn't here either.\n➞ No Library: you won't find your saved content and images.\n➞ No Search: Copilot search isn't accessible from Teams.\nSo usage focuses on chats and agents. For Notebooks, Create, the Library or Search, use the dedicated Copilot app or the web. But to query Copilot throughout the day, having it in Teams remains the handiest reflex.",
        "What to remember\nCopilot in Teams is Copilot right where you already work. Pin the icon in the left rail (or check that IT did it), and you reach the chat and your agents in one click.\nJust keep the current limits in mind: no Notebooks, no Create. For everything else day to day, driving Copilot from Teams is often the shortest path.",
      ],
    },
    stepImages: [
      null,
      "/articles/copilot-teams-rail.png",
      "/articles/copilot-teams-pin.png",
      "/articles/copilot-teams-welcome.png",
      null,
      null,
    ],
    imageCaptions: [
      { step: 1, text: { fr: "L'application Copilot épinglée dans le volet gauche de Teams.", en: "The Copilot app pinned in the Teams left rail." } },
      { step: 2, text: { fr: "Depuis le Store Teams : recherchez Copilot, puis « ... », puis « Pin » pour l'épingler.", en: "From the Teams Store: search Copilot, then « ... », then « Pin »." } },
      { step: 3, text: { fr: "Le chat Copilot dans Teams : la bascule Work / Web et vos agents dans le volet de gauche.", en: "The Copilot chat in Teams: the Work / Web toggle and your agents in the left pane." } },
    ],
    info: {
      fr: "Le chat Copilot dans Teams est accessible même sans licence (mode Web). Avec une licence Microsoft 365 Copilot, vous débloquez le mode Work, qui interroge vos données professionnelles (mails, fichiers, réunions).",
      en: "The Copilot chat in Teams is accessible even without a license (Web mode). With a Microsoft 365 Copilot license you unlock Work mode, which grounds answers on your work data (emails, files, meetings).",
    },
    tags: ["teams", "copilot dans teams", "épingler", "pin", "agents", "chat", "volet gauche", "limitations", "sans licence"],
  },
  {
  ...
  },
  {
    ...
    summary: {
      fr: "But, Contexte, Source, Attentes : les 4 ingrédients qui transforment un prompt vague en résultat exploitable. Plus votre prompt est clair et complet, plus la réponse de Copilot est pertinente.",
      en: "Goal, Context, Source, Expectations: the 4 ingredients that turn a vague prompt into a usable result. The clearer and more complete your prompt, the more relevant Copilot's answer.",
    },
    steps: {
      fr: [
        "Quatre ingrédients pour un prompt qui fait mouche\nUn bon prompt Copilot repose sur quatre ingrédients complémentaires : But, Contexte, Source, Attentes. Réunis, ils donnent à Copilot tout ce qu'il faut pour répondre juste du premier coup. Plus votre prompt est clair et complet, plus la réponse est pertinente.",
        "But : quelle réponse attendez-vous ?\nDites clairement le résultat que vous voulez obtenir. Exemple : « Générez 3 à 5 puces pour me préparer à une réunion avec le client X pour discuter de sa campagne de marque Phase 3+. » Astuce : soyez précis sur le résultat souhaité, type de contenu, nombre de points, ton ou niveau de détail.",
        "Contexte : pourquoi et pour qui ?\nExpliquez pourquoi vous en avez besoin et qui est concerné. Exemple : « Réunion avec l'équipe marketing et le client X. » Astuce : fournissez les éléments de contexte clés, projet, objectif, public cible, période concernée.",
        "Source : sur quoi Copilot doit s'appuyer ?\nIndiquez les sources d'information ou les échantillons que Copilot doit utiliser. Exemple : « Utilisez les e-mails et les chats Teams depuis juin, ainsi que les documents partagés dans le dossier Campagnes 2024 sur SharePoint. » Astuce : citez des sources précises et fiables, outils, dossiers, fichiers, rapports, données internes.",
        "Attentes : comment Copilot doit répondre ?\nPrécisez la forme et le comportement attendus. Exemple : « Utilisez un langage simple afin que je puisse me mettre à niveau rapidement. Structurez sous forme de puces claires et ajoutez un court résumé final. » Astuce : précisez le ton, le format, le style ou le niveau de détail, simple, synthétique, structuré, orienté action.",
        "En résumé : assemblez les quatre\nBut + Contexte + Source + Attentes = un prompt complet, donc une réponse pertinente. Et une fois le résultat satisfaisant, demandez à Copilot de vous rédiger le « prompt parfait » qui aurait permis d'obtenir directement ce résultat, puis gardez-le pour le réutiliser la prochaine fois.",
      ],
      en: [
        "Four ingredients for a prompt that hits the mark\nA good Copilot prompt relies on four complementary ingredients: Goal, Context, Source, Expectations. Together they give Copilot everything it needs to get it right the first time. The clearer and more complete your prompt, the more relevant the answer.",
        "Goal: what answer do you expect?\nState clearly the result you want. Example: “Generate 3 to 5 bullets to prepare me for a meeting with client X to discuss their Phase 3+ brand campaign.” Tip: be precise about the desired result, type of content, number of points, tone or level of detail.",
        "Context: why and for whom?\nExplain why you need it and who is concerned. Example: “Meeting with the marketing team and client X.” Tip: provide the key context, project, objective, target audience, period involved.",
        "Source: what should Copilot rely on?\nIndicate the information sources or samples Copilot should use. Example: “Use the emails and Teams chats since June, plus the documents shared in the Campaigns 2024 folder on SharePoint.” Tip: cite precise, reliable sources, tools, folders, files, reports, internal data.",
        "Expectations: how should Copilot respond?\nSpecify the expected shape and behavior. Example: “Use plain language so I can get up to speed quickly. Structure it as clear bullets and add a short final summary.” Tip: specify the tone, format, style or level of detail, simple, concise, structured, action-oriented.",
        "In short: assemble the four\nGoal + Context + Source + Expectations = a complete prompt, hence a relevant answer. And once you're happy with the result, ask Copilot to write you the “perfect prompt” that would have produced this result directly, then save it to reuse next time.",
      ],
    },
    stepImages: [
    ...
    imageWidth: "full",
    prompt: {
      fr: "Générez 3 à 5 puces pour me préparer à une réunion avec le client X pour discuter de sa campagne de marque « Phase 3+ ». Contexte : réunion avec l'équipe marketing et le client X. Source : utilisez les e-mails et les chats Teams depuis juin, ainsi que les documents partagés dans le dossier « Campagnes 2024 » sur SharePoint. Attentes : utilisez un langage simple afin que je puisse me mettre à niveau rapidement, structurez sous forme de puces claires et ajoutez un court résumé final.",
      en: "Generate 3 to 5 bullets to prepare me for a meeting with client X to discuss their « Phase 3+ » brand campaign. Context: meeting with the marketing team and client X. Source: use the emails and Teams chats since June, plus the documents shared in the « Campaigns 2024 » folder on SharePoint. Expectations: use plain language so I can get up to speed quickly, structure it as clear bullets and add a short final summary.",
    },
    tags: ["prompt engineering", "ingrédients", "but contexte source attentes", "chat", "productivité"],
  },
  {
