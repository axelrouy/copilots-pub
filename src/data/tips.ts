...
export const tips: Tip[] = [
  ...
  },
  {
    ...
    readMinutes: 5,
    title: {
      fr: "Agent Analyst : le data scientist de poche qui vit dans votre Copilot",
      en: "Analyst agent: the pocket data scientist living in your Copilot",
    },
    summary: {
      fr: "Agent Analyst, c'est l'agent de Microsoft 365 Copilot capable de transformer un tableur en désordre en vraies décisions business, simplement en discutant avec lui comme avec un collègue. Pas besoin d'être analyste : vous posez une question en français, il calcule, il raisonne et il vous répond. Démonstration avec un cas concret chez Nova Sports.",
      en: "The Analyst agent is the Microsoft 365 Copilot agent that turns a messy spreadsheet into real business decisions, simply by chatting with it like a colleague. No need to be an analyst: you ask a question in plain language, it computes, reasons and answers. Demo with a concrete case at Nova Sports.",
    },
    steps: {
      fr: [
        "Bienvenue au comptoir\nUne astuce pour tous ceux qui ouvrent un fichier Excel avec une petite boule au ventre.\nAgent Analyst transforme un tableur en désordre en vraies décisions. Vous posez une question en français, il calcule, il raisonne, il répond. Démonstration en cinq minutes.",
        "C'est quoi Agent Analyst ?\nUn data scientist virtuel qui lit vos fichiers Excel, CSV et exports de base, puis en tire tendances, anomalies et graphiques.\nSa particularité : il ne sort pas juste un chiffre. Il génère du code, l'exécute, vérifie et corrige jusqu'à une réponse fiable.\nTrois grandes missions :\n➞ Intégrer et nettoyer des données éparpillées.\n➞ Analyser en profondeur pour décider.\n➞ Raconter les chiffres avec des graphiques clairs.",
        "Le décor : Nova Sports\nImaginons Nova Sports, un e-commerçant de matériel de sport. Ses ventes du T1 2026 ne tiennent pas dans un seul fichier : deux exports par région, récupérés à la main.\nEt ils ne sont pas identiques : côté Sud, dates en texte, colonne « Code_Promo » en plus, notes de satisfaction parfois vides.\nMis bout à bout : 337 commandes, 44 079 € de chiffre d'affaires.",
        "Astuce n°1 : fusionner deux fichiers en une phrase\nOn charge les deux fichiers, on ouvre Analyst, et on lui demande de faire le ménage (prompt plus bas).\nIl aligne les colonnes, convertit les dates texte en vraies dates, harmonise les régions et repère les lignes incomplètes. Un fichier unique, propre, prêt à l'emploi.\nVingt minutes de copier-coller réglées en une phrase.",
        "Astuce n°2 : poser LA question qui fait mal\nChez Nova Sports, le marketing veut booster le Running (catégorie n°1) avec une remise de 15 %. Moins cher, plus de volume, plus de revenus... non ?\nAnalyst repart des vrais chiffres : la marge par article passe de 36,10 € à 21,83 €.\nVerdict : pour seulement maintenir la marge, il faudrait +65 % de volume. Une hausse de 30 % ferait perdre environ 1 065 € sur le trimestre.\nLa promo « évidente » était un piège à marge, évité en trente secondes.",
        "Et le graphique dans tout ça ?\nDemandez « fais-moi un graphique de la marge par catégorie et par région, puis résume les trois points à retenir ».\nAnalyst produit le visuel et son commentaire, dans la conversation. De la donnée brute au slide de comité, sans changer d'outil.",
        "Le bon réflexe pour un dashboard\nBesoin d'un vrai tableau de bord Excel (indicateurs, graphiques reliés à vos données) ? Ne le demandez pas à Analyst : passez par « Edit with Copilot » directement dans Excel.\nAnalyst excelle pour analyser et répondre. Mais pour un dashboard vivant dans le classeur, « Edit with Copilot » travaille sur votre fichier et vous laisse un tableau de bord modifiable.\nLe bon outil pour le bon livrable.",
        "Ce qu'il faut retenir\n➞ Vous parlez en français, Analyst fait les calculs.\n➞ Il ne devine pas : il raisonne, exécute du code, vérifie.\n➞ Il brille sur les questions « et si... ? ».\nEt pour un tableau de bord, le réflexe reste « Edit with Copilot » dans Excel.",
      ],
      en: [
        "Welcome to the counter\nA tip for everyone who opens an Excel file with a knot in their stomach.\nThe Analyst agent turns a messy spreadsheet into real decisions. You ask in plain language, it computes, reasons, answers. A five-minute demo.",
        "What is the Analyst agent?\nA virtual data scientist that reads your Excel files, CSVs and database exports, then draws out trends, anomalies and charts.\nIts trademark: it doesn't just spit out a number. It generates code, runs it, checks and fixes until the answer is reliable.\nThree big missions:\n➞ Integrate and clean scattered data.\n➞ Analyze in depth to decide.\n➞ Tell the numbers' story with clear charts.",
        "The setting: Nova Sports\nPicture Nova Sports, a sports-gear online retailer. Its Q1 2026 sales don't fit in one file: two exports per region, collected by hand.\nAnd they don't match: on the Sud side, text dates, an extra « Code_Promo » column, some empty satisfaction scores.\nPut end to end: 337 orders, 44,079 € in revenue.",
        "Tip #1: merge two files in one sentence\nYou load both files, open Analyst, and ask it to tidy up (prompt below).\nIt aligns the columns, converts text dates into real dates, harmonizes the regions and flags incomplete rows. One clean file, ready to use.\nTwenty minutes of copy-paste settled in one sentence.",
        "Tip #2: ask THE question that hurts\nAt Nova Sports, marketing wants to boost Running (the #1 category) with a 15% discount. Cheaper, more volume, more revenue... right?\nAnalyst goes back to the real numbers: margin per item drops from 36.10 € to 21.83 €.\nVerdict: just to hold the margin, you'd need +65% volume. A 30% increase would lose about 1,065 € over the quarter.\nThe « obvious » promo was a margin trap, avoided in thirty seconds.",
        "And what about the chart?\nAsk « make me a chart of margin by category and region, then summarize the three takeaways ».\nAnalyst produces the visual and its commentary, in the conversation. From raw data to a committee slide, without switching tools.",
        "The right reflex for a dashboard\nNeed a real Excel dashboard (KPIs, charts wired to your data)? Don't ask Analyst: use « Edit with Copilot » directly in Excel.\nAnalyst is great for analyzing and answering. But for a living dashboard in the workbook, « Edit with Copilot » works on your file and leaves you an editable dashboard.\nThe right tool for the right deliverable.",
        "What to remember\n➞ You speak plainly, Analyst does the math.\n➞ It doesn't guess: it reasons, runs code, checks.\n➞ It shines on « what if... ? » questions.\nAnd for a dashboard, the reflex stays « Edit with Copilot » in Excel.",
      ],
    },
    stepImages: [
      null,
      null,
      [
        "/articles/analyst-ventes-nord.png",
        "/articles/analyst-ventes-sud.png",
      ],
      "/articles/analyst-consolide.png",
      "/articles/analyst-question-marge.png",
      "/articles/analyst-graphique.png",
      "/articles/analyst-excel-dashboard.png",
      null,
    ],
    imageWidth: "md",
    stepVideos: [
      { src: "/articles/analyst-consolidation.mp4", step: 3, width: "full" },
    ],
    imageCaptions: [
      { step: 2, text: { fr: "Les deux exports bruts : Ventes_Nord_T1 et Ventes_Sud_T1 (dates en texte, colonne Code_Promo en plus, notes manquantes).", en: "The two raw exports: Ventes_Nord_T1 and Ventes_Sud_T1 (text dates, extra Code_Promo column, missing scores)." } },
      { step: 3, text: { fr: "Le fichier consolidé produit par Analyst : colonnes alignées, dates normalisées, régions harmonisées.", en: "The consolidated file produced by Analyst: aligned columns, normalized dates, harmonized regions." } },
      { step: 4, text: { fr: "Le raisonnement d'Analyst sur la remise Running : pourquoi la promo « évidente » ferait perdre de la marge.", en: "Analyst's reasoning on the Running discount: why the « obvious » promo would lose margin." } },
      { step: 5, text: { fr: "Le graphique de la marge par catégorie et par région, généré dans la conversation.", en: "The margin-by-category-and-region chart, generated in the conversation." } },
      { step: 6, text: { fr: "Avec « Edit with Copilot » dans Excel : tableau de synthèse et graphique créés directement dans le classeur.", en: "With « Edit with Copilot » in Excel: summary table and chart created directly in the workbook." } },
    ],
    prompt: {
      fr: "Consolide les fichiers Ventes_Nord_T1.xlsx et Ventes_Sud_T1.xlsx dans un nouveau fichier Excel qui reprend toutes les colonnes présentes dans l'un ou l'autre. Harmonise le format des dates, uniformise le nom des régions et signale-moi les lignes incomplètes.\n\nPuis : Sur la catégorie Running, nous envisageons une remise de 15 % sur le prix de vente, à coût d'achat inchangé. Quelle augmentation du volume faudrait-il atteindre pour au moins conserver notre marge actuelle ? Et une hausse de 30 % du volume suffirait-elle ?",
      en: "Consolidate the files Ventes_Nord_T1.xlsx and Ventes_Sud_T1.xlsx into a new Excel file that includes every column present in either one. Harmonize the date format, standardize the region name and flag the incomplete rows.\n\nThen: On the Running category, we're considering a 15% discount on the selling price, with purchase cost unchanged. What volume increase would we need to at least keep our current margin? And would a 30% volume increase be enough?",
    },
    links: [
      {
    ...
    tags: ["agents", "analyst", "analyse de données", "python", "data", "dashboard", "excel", "reasoning", "avec licence"],
  },
  {
    ...
    steps: {
      fr: [
        ...
        "L'activer pendant une réunion\nEn réunion, ouvrez « More actions », puis « Language and speech », et cliquez sur « Turn on Interpreter for me ». C'est le geste qui lance l'interprétation pour vous.\nSeule votre écoute est concernée : activer Interpreter « for me » ne change rien pour les autres participants, qui gardent leur propre réglage.",
        "Choisir sa langue et sa voix\nLe volet « Interpreter settings » s'ouvre. Deux réglages clés :\n➞ « Listen to the meeting in » : la langue dans laquelle vous voulez entendre la réunion.\n➞ « Choose your voice when interpreted » : soit « Simulate my voice » (la traduction reprend un timbre proche du vôtre, à partir de vos données vocales utilisées temporairement), soit « Automated voice » avec un choix de voix (Auto, Ava, Andrew, Brian, Fable Turbo...).\nRéglez aussi l'équilibre du volume entre l'audio d'origine et la traduction, selon votre confort.",
        "Quand la traduction tourne\nUne fois actif, un indicateur « AI is interpreting this meeting » vous rappelle que vous utilisez Interpreter et dans quelle langue. Depuis là, vous pouvez à tout moment « Manage settings » pour ajuster, ou « Turn off for me » pour couper.\nLa langue parlée est détectée automatiquement et se reflète dans les sous-titres en direct et la transcription.",
        "Deux bonnes pratiques pour une traduction fluide\nInterpreter a besoin d'un petit temps pour bien faire : au démarrage, un rappel vous invite à « laisser le temps à l'IA ». Deux réflexes aident la qualité :\n➞ L'agent attend qu'une phrase soit terminée avant de la traduire pour les autres : parlez par phrases complètes.\n➞ Attendez que l'indicateur sur la vidéo de la personne disparaisse avant de prendre la parole, pour ne pas couper ceux qui écoutent la traduction.",
        "Sur mobile aussi\nEn déplacement, c'est tout aussi simple. Sur Teams mobile (iOS ou Android) : « More », puis « Turn on Interpreter », sélectionnez la langue, et validez. Vous suivez la réunion traduite depuis votre téléphone.",
        "Les prérequis à connaître\nAvant de vous lancer, gardez ces points en tête :\n➞ Teams Premium : permet d'activer Interpreter dans les réunions Teams.\n➞ Microsoft 365 Copilot : inclut aussi Interpreter et apporte les heures d'interprétation incluses ainsi que l'expérience IA avancée.\n➞ 20 heures d'interprétation incluses par utilisateur et par mois avec une licence Microsoft 365 Copilot ; au-delà, selon la capacité disponible.\n➞ Une dizaine de langues prises en charge (anglais, français, espagnol, portugais, allemand, italien, japonais, chinois mandarin, coréen, entre autres).\n➞ Disponible dans les réunions planifiées et de canal (desktop, mobile, web, Teams Rooms sur Windows), mais pas dans les appels improvisés, les webinaires/town halls, ni Teams gratuit.\n➞ La traduction n'est pas capturée dans l'enregistrement ni la transcription, qui restent dans la langue d'origine.",
      ...
      en: [
        ...
        "Turn it on during a meeting\nIn a meeting, open « More actions », then « Language and speech », and click « Turn on Interpreter for me ». That's the gesture that starts interpretation for you.\nOnly your listening is affected: turning Interpreter on « for me » changes nothing for the other participants, who keep their own setting.",
        "Choose your language and voice\nThe « Interpreter settings » pane opens. Two key settings:\n➞ « Listen to the meeting in »: the language you want to hear the meeting in.\n➞ « Choose your voice when interpreted »: either « Simulate my voice » (the translation takes on a tone close to yours, from your temporarily used voice data), or « Automated voice » with a choice of voices (Auto, Ava, Andrew, Brian, Fable Turbo...).\nAlso adjust the volume balance between the original audio and the translation, to your liking.",
        "When translation is running\nOnce active, an « AI is interpreting this meeting » indicator reminds you that you're using Interpreter and in which language. From there, you can « Manage settings » to adjust, or « Turn off for me » to stop, at any time.\nThe spoken language is detected automatically and reflected in live captions and the transcript.",
        "Two good habits for smooth translation\nInterpreter needs a little time to do well: at the start, a reminder invites you to « allow time for the AI ». Two reflexes help quality:\n➞ The agent waits for a sentence to be finished before translating it for others: speak in complete sentences.\n➞ Wait for the indicator on the person's video to disappear before speaking, so you don't cut off those listening to the translation.",
        "On mobile too\nOn the go, it's just as simple. On Teams mobile (iOS or Android): « More », then « Turn on Interpreter », pick the language and confirm. You follow the translated meeting from your phone.",
        "The prerequisites to know\nBefore you start, keep these points in mind:\n➞ Teams Premium: lets you turn Interpreter on in Teams meetings.\n➞ Microsoft 365 Copilot: also includes Interpreter and brings the included interpretation hours plus the advanced AI experience.\n➞ 20 hours of interpretation included per user per month with a Microsoft 365 Copilot license; beyond that, subject to available capacity.\n➞ Around ten supported languages (English, French, Spanish, Portuguese, German, Italian, Japanese, Mandarin Chinese, Korean, among others).\n➞ Available in scheduled and channel meetings (desktop, mobile, web, Teams Rooms on Windows), but not in ad-hoc calls, webinars/town halls, or Teams Free.\n➞ The translation isn't captured in the recording or transcript, which stay in the original language.",
    ...
    stepImages: [
      null,
      "/articles/interpreter-turn-on.png",
      "/articles/interpreter-settings.png",
      "/articles/interpreter-active.png",
      [
        "/articles/interpreter-tip1.png",
        "/articles/interpreter-tip2.png",
      ],
      null,
      null,
      null,
    ...
    imageWidth: "md",
    imageCaptions: [
      { step: 1, text: { fr: "En réunion : More actions › Language and speech › Turn on Interpreter for me.", en: "In a meeting: More actions › Language and speech › Turn on Interpreter for me." } },
      { step: 2, text: { fr: "Les réglages Interpreter : la langue d'écoute et le choix de la voix (voix simulée ou voix automatisée).", en: "Interpreter settings: the listening language and the voice choice (simulated or automated voice)." } },
      { step: 3, text: { fr: "L'indicateur « AI is interpreting this meeting », avec Manage settings et Turn off for me.", en: "The « AI is interpreting this meeting » indicator, with Manage settings and Turn off for me." } },
      { step: 4, text: { fr: "Les rappels de bonnes pratiques affichés au démarrage de l'interprétation.", en: "The good-practice reminders shown when interpretation starts." } },
    ],
    info: {
  ...
  },
  {
    ...
    readMinutes: 5,
    title: {
      fr: "Sondages et Copilot : le Surveys Agent laisse place à Copilot dans Forms",
      en: "Surveys and Copilot: the Surveys Agent gives way to Copilot in Forms",
    },
    summary: {
      fr: "À connaître : le Surveys Agent est en cours de retrait. Ses capacités de création, de diffusion et d'analyse d'enquêtes sont désormais regroupées dans une expérience Copilot unifiée au sein de Microsoft Forms. Bonne nouvelle : vous gardez tout, au même endroit, directement dans Forms.",
      en: "Good to know: the Surveys Agent is being retired. Its survey creation, distribution and analysis capabilities are now bundled into a unified Copilot experience inside Microsoft Forms. Good news: you keep everything, in one place, right in Forms.",
    },
    steps: {
      fr: [
        "Une évolution à connaître\nSi vous cherchiez le Surveys Agent, voici l'info importante : il est en cours de retrait. Ses principales capacités sont désormais regroupées dans une expérience Copilot unifiée au sein de Microsoft Forms.\nAutrement dit, plus besoin d'un agent séparé : tout ce que vous faisiez dans « Enquêtes » se fait maintenant directement dans Forms, avec Copilot. Un message vous le rappelle et vous invite à basculer.",
        "Le nouveau point d'entrée : Copilot dans Forms\nOuvrez Microsoft Forms. Copilot vous accompagne tout au long du processus : créer, améliorer, envoyer et analyser vos formulaires.\nLe geste de départ est simple : « Commencer la rédaction », et vous décrivez ce que vous voulez mesurer.",
        "Créer une enquête en conversant\nDécrivez votre besoin en langage naturel (« un sondage de satisfaction après ma formation », « une enquête d'engagement pour mon équipe »). Copilot génère un brouillon de formulaire prêt à l'emploi.\nEnsuite, vous affinez : demandez-lui d'améliorer la clarté et la structure des questions, ou d'ajuster le style. La vidéo ci-dessous montre le déroulé.",
        "Diffuser et recueillir les réponses\nAu moment d'envoyer, vous choisissez qui peut répondre (tout le monde, uniquement votre organisation, ou des personnes précises) et vous partagez le lien, un QR code ou un code d'intégration.\nCopilot aide aussi à rédiger le message d'invitation (« Réécrire avec Copilot »), et vous diffusez via Outlook ou un canal Teams pour maximiser le taux de réponse.",
        "Analyser les résultats\nUne fois les réponses collectées, Copilot dans Forms vous aide à faire parler les données : synthèse des retours, tendances, points saillants. De quoi passer du recueil à la décision sans changer d'outil.\nQuelques cas d'usage : évaluation post-formation, enquête d'engagement, étude client, feedback projet, ou un NPS.",
        "Ce qu'il faut retenir\nLe Surveys Agent disparaît, mais rien ne se perd : créer, améliorer, envoyer et analyser vos enquêtes se fait désormais avec Copilot, directement dans Microsoft Forms. Un seul endroit, de la première question à l'analyse des réponses.",
      ],
      en: [
        "An evolution to know about\nIf you were looking for the Surveys Agent, here's the key info: it's being retired. Its main capabilities are now bundled into a unified Copilot experience inside Microsoft Forms.\nIn other words, no more separate agent: everything you used to do in « Surveys » now happens directly in Forms, with Copilot. A message reminds you and invites you to switch.",
        "The new entry point: Copilot in Forms\nOpen Microsoft Forms. Copilot supports you throughout the process: create, improve, send and analyze your forms.\nThe starting move is simple: « Start drafting », and you describe what you want to measure.",
        "Create a survey by chatting\nDescribe your need in plain language (« a satisfaction survey after my training », « an engagement survey for my team »). Copilot generates a ready-to-use form draft.\nThen you refine: ask it to improve the clarity and structure of the questions, or adjust the style. The video below shows the flow.",
        "Distribute and collect responses\nWhen sending, you choose who can respond (everyone, only your organization, or specific people) and share the link, a QR code or an embed code.\nCopilot also helps write the invitation message (« Rewrite with Copilot »), and you distribute via Outlook or a Teams channel to maximize the response rate.",
        "Analyze the results\nOnce responses are in, Copilot in Forms helps make the data talk: summary of feedback, trends, highlights. Enough to go from collection to decision without switching tools.\nA few use cases: post-training evaluation, engagement survey, customer study, project feedback, or an NPS.",
        "What to remember\nThe Surveys Agent is going away, but nothing is lost: creating, improving, sending and analyzing your surveys now happens with Copilot, directly in Microsoft Forms. One place, from the first question to analyzing the responses.",
      ],
    },
    stepImages: [
      "/articles/surveys-forms-retirement.png",
      "/articles/surveys-forms-welcome.png",
      null,
      "/articles/surveys-forms-send.png",
      null,
      null,
    ],
    imageWidth: "md",
    stepVideos: [
      { src: "/articles/surveys-forms-create.mp4", step: 2, width: "full" },
    ],
    imageCaptions: [
      { step: 0, text: { fr: "Le message officiel : tout ce que vous faisiez dans Enquêtes est désormais intégré à Forms.", en: "The official message: everything you did in Surveys is now integrated into Forms." } },
      { step: 1, text: { fr: "Copilot dans Microsoft Forms : créer, améliorer, envoyer et analyser vos formulaires.", en: "Copilot in Microsoft Forms: create, improve, send and analyze your forms." } },
      { step: 3, text: { fr: "L'envoi : audience, lien / QR / intégration, réécriture du message avec Copilot, diffusion Outlook ou Teams.", en: "Sending: audience, link / QR / embed, invitation rewrite with Copilot, Outlook or Teams distribution." } },
    ],
    info: {
      fr: "Le Surveys Agent est en cours de retrait : ses capacités sont désormais dans Copilot pour Microsoft Forms. La disponibilité de Copilot dans Forms peut dépendre de votre licence et de la configuration de votre organisation : voyez avec votre IT.",
      en: "The Surveys Agent is being retired: its capabilities are now in Copilot for Microsoft Forms. Availability of Copilot in Forms may depend on your license and your organization's configuration: check with your IT.",
    },
    links: [
      {
        label: { fr: "Blog Microsoft Forms (annonces officielles)", en: "Microsoft Forms blog (official announcements)" },
  ...
  },
  {
    ...
    summary: {
      fr: "Le Microsoft 365 Admin Agent est un assistant agentique pour les administrateurs IT : au lieu de naviguer entre dix portails, vous demandez en langage naturel (« combien de licences Copilot disponibles ? », « Teams est-il en panne ? »), et l'agent interroge, recommande et propose des actions, toujours avec votre confirmation.",
      en: "The Microsoft 365 Admin Agent is an agentic assistant for IT administrators: instead of navigating ten portals, you ask in natural language (« how many Copilot licenses are available? », « is Teams down? »), and the agent queries, recommends and proposes actions, always with your confirmation.",
    },
    steps: {
      fr: [
        ...
        "Où l'utiliser : deux surfaces reliées\nL'agent vit à deux endroits, avec continuité de contexte entre les deux :\n➞ Dans le centre d'administration Microsoft 365 (admin.microsoft.com) : cliquez sur le bouton « Copilot » en haut ; l'agent Admin est déjà sélectionné.\n➞ Dans Microsoft 365 Copilot Chat : allez dans « Agents » et choisissez « Microsoft 365 Admin ».\nVous pouvez démarrer une demande dans le chat, puis la poursuivre dans l'admin center sans perdre le fil. Des invites suggérées vous aident à démarrer.",
        "Les prérequis pour l'utiliser\nPour utiliser l'agent, il faut avant tout être administrateur du tenant : l'agent est réservé aux rôles d'administration, pas aux utilisateurs finaux.\n➞ Rôle « AI Administrator » : pour utiliser l'agent et configurer les scénarios.\n➞ Rôle « Global Reader » : pour un accès en lecture seule.\n➞ Il respecte les permissions de l'admin connecté (un admin Teams gère les politiques Teams, pas les paramètres SharePoint).\nBonne nouvelle : il ne demande pas de licence Microsoft 365 Copilot supplémentaire, il s'appuie sur les rôles d'administration existants.",
        "Ce qu'il sait faire\nQuelques demandes que vous pouvez lui adresser :\n➞ « Combien de licences Copilot sont disponibles ? » : il retourne la répartition par produit (total, assignées, disponibles).\n➞ « Partage-moi les messages du Message Center relatifs à Copilot. » : il liste les MC avec titre, service et résumé.\n➞ « Mon organisation est-elle prête pour Copilot ? Que dois-je prioriser ? »\n➞ « Teams est-il en panne ? Mes utilisateurs ont des soucis de mails. »\n➞ « Affiche le statut MFA et active l'authentification sans mot de passe. »\nIl interroge les bons services, corrèle avec l'état en temps réel, et propose l'action.",
        "Il agit toujours avec votre validation\nQuand une demande implique une modification (par exemple « Attribue une licence Microsoft 365 Copilot à Joe Dalton »), l'agent n'exécute rien tout seul : il affiche d'abord une carte récapitulant les paramètres de l'action et un avertissement, puis attend que vous cliquiez sur « Accepter » ou « Refuser ».\nEt tout est journalisé : les opérations se retrouvent dans les journaux d'audit des services concernés (centre d'administration Microsoft 365, Microsoft Entra, admin Teams). Vous gardez le contrôle et la traçabilité.",
        "Ce qu'il faut retenir\nLe Microsoft 365 Admin Agent, c'est l'administration en langage naturel : moins de navigation entre portails, des réponses et des actions guidées, sans licence Copilot supplémentaire, mais réservé aux administrateurs selon leurs rôles. L'agent propose, l'admin dispose, et tout reste audité.",
      ],
      en: [
        ...
        "Where to use it: two connected surfaces\nThe agent lives in two places, with context continuity between them:\n➞ In the Microsoft 365 admin center (admin.microsoft.com): click the « Copilot » button at the top; the Admin agent is already selected.\n➞ In Microsoft 365 Copilot Chat: go to « Agents » and choose « Microsoft 365 Admin ».\nYou can start a request in the chat, then continue it in the admin center without losing the thread. Suggested prompts help you get started.",
        "The prerequisites to use it\nTo use the agent, you must first be a tenant administrator: it's reserved for admin roles, not end users.\n➞ « AI Administrator » role: to use the agent and configure scenarios.\n➞ « Global Reader » role: for read-only access.\n➞ It honors the signed-in admin's permissions (a Teams admin manages Teams policies, not SharePoint settings).\nGood news: it doesn't require an extra Microsoft 365 Copilot license, it relies on existing admin roles.",
        "What it can do\nA few requests you can give it:\n➞ « How many Copilot licenses are available? »: it returns the breakdown per product (total, assigned, available).\n➞ « Share the Message Center posts related to Copilot. »: it lists the MCs with title, service and summary.\n➞ « Is my org ready for Copilot? What should I prioritize? »\n➞ « Is Teams down? My users have email problems. »\n➞ « Show the MFA status and turn on passwordless authentication. »\nIt queries the right services, correlates with real-time status, and proposes the action.",
        "It always acts with your approval\nWhen a request involves a change (for example « Assign a Microsoft 365 Copilot license to Joe Dalton »), the agent runs nothing on its own: it first shows a card summarizing the action's parameters and a warning, then waits for you to click « Accept » or « Decline ».\nAnd everything is logged: operations show up in the audit logs of the relevant services (Microsoft 365 admin center, Microsoft Entra, Teams admin). You keep control and traceability.",
        "What to remember\nThe Microsoft 365 Admin Agent is administration in natural language: less portal hopping, guided answers and actions, with no extra Copilot license, but reserved for administrators based on their roles. The agent proposes, the admin decides, and everything stays audited.",
      ],
    },
    stepImages: [
      null,
      "/articles/m365-admin-home.png",
      null,
      [
        "/articles/m365-admin-licenses.png",
        "/articles/m365-admin-message-center.png",
      ],
      "/articles/m365-admin-assign-license.png",
      null,
    ],
    imageWidth: "md",
    imageCaptions: [
      { step: 1, text: { fr: "L'agent Microsoft 365 Admin dans Copilot, avec ses invites suggérées (licences, fonctionnalités, mises à jour).", en: "The Microsoft 365 Admin agent in Copilot, with its suggested prompts (licenses, features, updates)." } },
      { step: 3, text: { fr: "Deux exemples : la répartition des licences Copilot, et les messages du Message Center liés à Copilot.", en: "Two examples: the Copilot license breakdown, and the Message Center posts related to Copilot." } },
      { step: 4, text: { fr: "Avant toute modification, l'agent demande une confirmation explicite (Accepter / Refuser).", en: "Before any change, the agent asks for explicit confirmation (Accept / Decline)." } },
    ],
    info: {
      fr: "Le Microsoft 365 Admin Agent est réservé aux administrateurs : rôle AI Administrator pour agir, Global Reader en lecture seule. Il ne nécessite pas de licence Microsoft 365 Copilot supplémentaire, respecte les permissions RBAC de l'admin connecté, et toute action modifiante demande une confirmation explicite.",
      en: "The Microsoft 365 Admin Agent is reserved for administrators: AI Administrator role to act, Global Reader for read-only. It doesn't require an extra Microsoft 365 Copilot license, honors the signed-in admin's RBAC permissions, and any changing action requires explicit confirmation.",
    },
    links: [
      {
  ...
  },
  {
    ...
    summary: {
      fr: "Cowork ne se raisonne pas comme une licence de plus, mais comme une valeur consommée : vous payez le travail réellement effectué. On voit le cadre en quatre briques, comment classer les missions (Light, Medium, Heavy) pour cadrer un budget, pourquoi le paiement à l'usage est intéressant, et comment repérer vos meilleurs cas d'usage.",
      en: "Cowork isn't reasoned about like one more license, but like value consumed: you pay for the work actually done. Let's look at the four-building-block framework, how to classify missions (Light, Medium, Heavy) to size a budget, why pay-as-you-go is interesting, and how to spot your best use cases.",
    },
    steps: {
      fr: [
        ...
        "Le cadre en quatre briques\nPour situer chaque élément sans se perdre :\n➞ Licence Copilot : la productivité individuelle, dans vos apps du quotidien.\n➞ Cowork : l'automatisation de tâches multi-étapes, à plus grande échelle.\n➞ Crédits : le coût, aligné sur la valeur produite (paiement à l'usage).\n➞ FinOps : le pilotage (budgets, alertes, plafonds, gouvernance).\nChaque brique a son rôle ; ensemble, elles cadrent proprement l'adoption.",
        "Comment ça marche : le paiement à l'usage\nCowork demande deux choses côté organisation : une licence Microsoft 365 Copilot active, et le paiement à l'usage (usage-based billing) activé par l'IT. C'est ce second point qui débloque l'exécution des tâches.\nLe modèle officiel s'appelle pay-as-you-go (PAYGO). L'usage se mesure en crédits Copilot. Le coût réel dépend du travail effectivement réalisé : le modèle utilisé, le volume de contexte, les appels aux outils et l'orchestration. Inutile de viser le centime près.",
        "Classer les missions : Light, Medium, Heavy\nPlutôt que de deviner un coût exact, classez chaque mission en trois niveaux pour obtenir un ordre de grandeur. C'est la façon la plus simple de cadrer une dépense.\n➞ Light : une tâche courte et ciblée.\n➞ Medium : une analyse ou une synthèse à plusieurs sources.\n➞ Heavy : un livrable complet sur de gros volumes.\nLe tableau ci-dessous donne des ordres de grandeur illustratifs (à ajuster selon la complexité réelle et vos conditions commerciales).",
        "Construire son budget pilote\nUne méthode simple en cinq temps :\n➞ Identifier vos cas d'usage.\n➞ Les classer Light, Medium ou Heavy.\n➞ Estimer leur fréquence mensuelle.\n➞ Multiplier pour obtenir une enveloppe mensuelle.\n➞ Utiliser cette enveloppe pour lancer un pilote.\nExemple illustratif : une préparation de CODIR (Medium, 4 fois par mois), une veille réglementaire (Light, 20 fois par mois) et une réponse à appel d'offres (Heavy, 2 fois par mois) donnent une première enveloppe de l'ordre de 90 $ par mois. À vous d'ajuster avec vos propres chiffres.",
        "Parler valeur, pas coût\nLe vrai sujet n'est pas le montant, mais la valeur métier générée. La bonne question : combien coûte aujourd'hui cette activité en temps humain, en délai et en risque qualité ?\nComparez alors le coût d'une exécution Cowork avec celui d'une tâche qui mobilise plusieurs personnes pendant plusieurs heures. Une revue mensuelle, une analyse de dossier complexe ou une veille récurrente basculent vite du côté du gain : temps économisé, meilleure qualité, régularité, décisions plus rapides.",
        "FinOps : garder la main\nLe paiement à l'usage ne veut pas dire perte de contrôle. Côté gouvernance, l'IT dispose de leviers officiels :\n➞ Une billing policy qui relie l'usage à un abonnement Azure.\n➞ Des budgets avec alertes par e-mail (attention : ils notifient mais ne bloquent pas automatiquement).\n➞ Des plafonds de consommation par agent et un suivi de la consommation.\n➞ La visibilité des coûts dans Microsoft Cost Management (Azure), avec répartition par équipe.\nLe bon réflexe : commencer petit, poser des plafonds, suivre, puis étendre sur les cas à plus forte valeur.",
        "Trouver vos cas d'usage\nLa valeur vient des bons cas d'usage. Pour les repérer dans votre contexte :\n➞ Partez de votre rôle : quelles tâches répétitives et multi-étapes vous prennent du temps chaque semaine ?\n➞ Cherchez les missions chronophages à faible valeur ajoutée (consolidation, mise en forme, relances, reporting récurrent).\n➞ Estimez la valeur produite (temps gagné, régularité, qualité) avant le coût.\n➞ Testez sur un périmètre restreint, mesurez, puis élargissez ce qui prouve sa valeur.",
        "Ce qu'il faut retenir\nCowork se raisonne en valeur consommée : on paie le travail fait, pas une moyenne. Le cadre licence / Cowork / crédits / FinOps aide à décider, et le classement Light / Medium / Heavy à cadrer un budget.\nCommencez petit, mesurez, gouvernez, et laissez les cas d'usage qui prouvent leur valeur guider l'échelle.",
      ],
      en: [
        ...
        "The four-building-block framework\nTo place each element without getting lost:\n➞ Copilot license: individual productivity, in your everyday apps.\n➞ Cowork: automation of multi-step tasks, at a larger scale.\n➞ Credits: cost, aligned to the value produced (pay-as-you-go).\n➞ FinOps: steering (budgets, alerts, caps, governance).\nEach block has its role; together they frame adoption cleanly.",
        "How it works: pay-as-you-go\nCowork asks two things of the organization: an active Microsoft 365 Copilot license, and usage-based billing enabled by IT. That second point unlocks task execution.\nThe official model is called pay-as-you-go (PAYGO). Usage is measured in Copilot Credits. The real cost depends on the work actually done: the model used, the volume of context, tool calls and orchestration. No need to aim for the exact cent.",
        "Classify missions: Light, Medium, Heavy\nRather than guessing an exact cost, classify each mission into three levels to get an order of magnitude. It's the simplest way to size a spend.\n➞ Light: a short, targeted task.\n➞ Medium: a multi-source analysis or synthesis.\n➞ Heavy: a full deliverable on large volumes.\nThe table below gives illustrative orders of magnitude (to be adjusted to real complexity and your commercial terms).",
        "Build your pilot budget\nA simple five-step method:\n➞ Identify your use cases.\n➞ Classify them Light, Medium or Heavy.\n➞ Estimate their monthly frequency.\n➞ Multiply to get a monthly envelope.\n➞ Use that envelope to launch a pilot.\nIllustrative example: a steering-committee prep (Medium, 4 times a month), a regulatory watch (Light, 20 times a month) and an RFP response (Heavy, 2 times a month) give a first envelope of around $90 a month. Adjust with your own numbers.",
        "Talk value, not cost\nThe real topic isn't the amount, but the business value created. The right question: how much does this activity cost today in human time, delay and quality risk?\nThen compare the cost of one Cowork run with a task that mobilizes several people for several hours. A monthly review, a complex file analysis or a recurring watch quickly tip to the gain side: time saved, better quality, consistency, faster decisions.",
        "FinOps: stay in control\nPay-as-you-go doesn't mean losing control. On governance, IT has official levers:\n➞ A billing policy linking usage to an Azure subscription.\n➞ Budgets with email alerts (careful: they notify but don't automatically block).\n➞ Per-agent consumption caps and usage monitoring.\n➞ Cost visibility in Microsoft Cost Management (Azure), with per-team breakdown.\nThe right reflex: start small, set caps, monitor, then scale on the higher-value cases.",
        "Find your use cases\nValue comes from the right use cases. To spot them in your context:\n➞ Start from your role: which repetitive, multi-step tasks eat your time each week?\n➞ Look for time-consuming, low-value missions (consolidation, formatting, follow-ups, recurring reporting).\n➞ Estimate the value produced (time saved, consistency, quality) before the cost.\n➞ Test on a small scope, measure, then scale what proves its value.",
        "What to remember\nCowork is reasoned about in value consumed: you pay for work done, not an average. The license / Cowork / credits / FinOps framework helps you decide, and the Light / Medium / Heavy classification helps size a budget.\nStart small, measure, govern, and let the use cases that prove their value guide the scale.",
      ],
    },
    stepImages: [
      null,
      "/articles/cowork-pricing-framework.png",
      null,
      "/articles/cowork-pricing-tiers.png",
      null,
      null,
      null,
      null,
    ...
    stepTable: {
      ...
      columns: [
        { fr: "Niveau", en: "Level" },
        { fr: "Crédits (ordre de grandeur)", en: "Credits (order of magnitude)" },
        { fr: "Coût indicatif", en: "Indicative cost" },
        { fr: "Exemples", en: "Examples" },
      ],
      rows: [
        [
          { fr: "Light", en: "Light" },
          { fr: "70 à 200", en: "70 to 200" },
          { fr: "~ 0,70 $ à 2 $", en: "~ $0.70 to $2" },
          { fr: "Résumé ciblé, brouillon court, recherche simple", en: "Targeted summary, short draft, simple search" },
        ],
        [
          { fr: "Medium", en: "Medium" },
          { fr: "400 à 600", en: "400 to 600" },
          { fr: "~ 4 $ à 6 $", en: "~ $4 to $6" },
          { fr: "Note de cadrage, préparation de revue, analyse multi-fichiers", en: "Scoping note, review prep, multi-file analysis" },
        ],
        [
          { fr: "Heavy", en: "Heavy" },
          { fr: "1 500 et plus", en: "1,500 and more" },
          { fr: "~ 15 $ et plus", en: "~ $15 and more" },
          { fr: "Rapport complet, analyse de contrat, veille étendue", en: "Full report, contract analysis, extended watch" },
        ],
      ],
    },
    info: {
      fr: "Cowork nécessite une licence Microsoft 365 Copilot ET le paiement à l'usage (usage-based billing) activé par l'IT. Les niveaux Light / Medium / Heavy et leurs coûts sont des ordres de grandeur illustratifs pour cadrer un budget, pas une grille de prix officielle Microsoft. Utilisez l'estimateur officiel et voyez avec votre IT et vos conditions commerciales.",
      en: "Cowork requires a Microsoft 365 Copilot license AND usage-based billing enabled by IT. The Light / Medium / Heavy levels and their costs are illustrative orders of magnitude to size a budget, not an official Microsoft price list. Use the official estimator and check with your IT and commercial terms.",
    },
    links: [
      {
