...
export const tips: Tip[] = [
  ...
  },
  {
    ...
    stepImages: [null, null, null, "/articles/cowork-whats-new-email.png", null, null, null],
    imageCaptions: [
    ...
    info: {
      fr: "Cowork nécessite une licence Microsoft 365 Copilot. La planification récurrente et l'accès à vos canaux Teams / à votre messagerie dépendent des capacités agentiques activées dans votre environnement.",
      en: "Cowork requires a Microsoft 365 Copilot license. Recurring scheduling and access to your Teams channels / mailbox depend on the agentic capabilities enabled in your environment.",
    },
    prompt: {
