...
export const tips: Tip[] = [
  ...
  },
  {
    ...
    steps: {
      fr: [
        "Bienvenue au comptoir\nVoici une astuce qui parlera à tous ceux qui ouvrent un fichier Excel avec une petite boule au ventre. Agent Analyst transforme un tableur en désordre en vraies décisions, simplement en discutant avec lui comme avec un collègue. Pas besoin d'être analyste : vous posez une question en français, il calcule, il raisonne et il répond.\nOn va le prouver avec un cas d'usage tout simple, que vous pourrez rejouer en cinq minutes.",
        "C'est quoi Agent Analyst, exactement ?\nAnalyst a été conçu pour transformer des données complexes et mal rangées en informations utiles, au fil d'une simple conversation. Il lit vos fichiers Excel, vos CSV et vos exports de base de données, puis en tire des tendances, des anomalies et des graphiques.\nSa vraie particularité, c'est sa façon de réfléchir. Il ne se contente pas de sortir un chiffre : il génère du code, l'exécute, vérifie ses résultats, corrige ses erreurs et recommence jusqu'à une réponse fiable. Un data scientist virtuel disponible en permanence, qui ne soupire jamais quand vous changez d'avis.\nOn lui confie surtout trois grandes familles de missions :\n➞ Intégrer et nettoyer des données éparpillées dans plusieurs fichiers.\n➞ Analyser en profondeur pour éclairer une décision.\n➞ Raconter l'histoire des chiffres avec des graphiques clairs.",
        "Le décor : bienvenue chez Nova Sports\nPour la démonstration, imaginons Nova Sports, un e-commerçant français de matériel de sport. Comme dans la vraie vie, ses ventes du premier trimestre 2026 ne tiennent pas dans un seul beau fichier.\nElles sont éclatées en deux exports, un par région, récupérés à la main : Ventes_Nord_T1 et Ventes_Sud_T1. Et bien sûr, les deux ne sont pas identiques : dans celui du Sud, les dates sont écrites en texte, une colonne « Code_Promo » traîne en plus, et quelques notes de satisfaction sont vides. Bref, le quotidien de n'importe quelle équipe.\nMis bout à bout, ces deux fichiers représentent 337 commandes et 44 079 € de chiffre d'affaires.",
        "Astuce n°1 : fusionner deux fichiers d'un simple bonjour\nLe premier réflexe utile, c'est d'arrêter de recopier des colonnes à la main. On charge les deux fichiers dans Copilot, on ouvre Agent Analyst et on lui demande gentiment de faire le ménage (voir le prompt plus bas).\nCe qui se passe ensuite tient de la magie tranquille. Analyst aligne les colonnes, y compris « Code_Promo » qui n'existe que d'un côté, convertit les dates texte en vraies dates, remet « Sud » au propre et repère les notes de satisfaction manquantes. Il vous rend un fichier unique, propre et prêt à l'emploi. Vingt minutes de copier-coller réglées en une phrase.",
        "Astuce n°2 : poser LA question qui fait mal\nC'est ici qu'Analyst quitte le rôle de « macro sympa » pour devenir un vrai copilote de décision. Chez Nova Sports, l'équipe marketing a une idée qui semble évidente : le Running est la catégorie n°1 en chiffre d'affaires (13 129 €), alors pourquoi ne pas doper les ventes avec une remise de 15 % ? Moins cher, donc plus de volume, donc plus de revenus... non ?\nAnalyst repart des données réelles. Prix moyen d'un article Running : 95,13 €, coût 59,03 €, soit 36,10 € de marge par unité. Baisser le prix de 15 % le fait tomber à 80,86 €, mais le coût ne bouge pas : la marge par article s'effondre à 21,83 €.\nLa conclusion est implacable : pour seulement maintenir la marge, il faudrait vendre 65 % de volume en plus. Et une hausse déjà optimiste de 30 % ? Elle ferait perdre environ 1 065 € de marge sur le trimestre. La promo qui semblait évidente est un piège à marge, et Analyst l'explique étape par étape, sans jargon.",
        "Et le graphique dans tout ça ?\nDernier atout : la mise en récit visuelle. Demandez simplement « fais-moi un graphique de la marge par catégorie et par région, puis résume les trois points à retenir », et Analyst produit le visuel et son commentaire. De la donnée brute au slide de comité de direction, sans quitter la conversation.",
        "Le bon réflexe pour un dashboard\nUn conseil pour aller plus loin : si votre besoin est un vrai tableau de bord Excel (indicateurs, filtres, graphiques reliés à vos données), ne le demandez pas à Analyst mais passez par « Edit with Copilot » directement dans Excel.\nLa logique : Analyst est imbattable pour analyser, répondre à une question « et si... ? » et sortir un graphique ponctuel. Mais pour construire un dashboard vivant dans le classeur, l'expérience « Edit with Copilot » d'Excel travaille nativement sur votre fichier et vous laisse un tableau de bord directement exploitable et modifiable. Le bon outil pour le bon livrable.",
        "Ce qu'il faut retenir\nTrois idées simples :\n➞ Vous parlez en français, Analyst fait les calculs.\n➞ Il ne devine pas : il raisonne, exécute du code et vérifie ses résultats.\n➞ Il brille surtout sur les questions « et si... ? », là où l'intuition se trompe.\nEt pour un tableau de bord, gardez le réflexe « Edit with Copilot » dans Excel.",
      ],
      en: [
        "Welcome to the counter\nHere's a tip for everyone who opens an Excel file with a knot in their stomach. The Analyst agent turns a messy spreadsheet into real decisions, simply by chatting with it like a colleague. No need to be an analyst: you ask a question in plain language, it computes, reasons and answers.\nLet's prove it with a very simple use case you can replay in five minutes.",
        "What is the Analyst agent, exactly?\nAnalyst was built to turn complex, messy data into useful information through a simple conversation. It reads your Excel files, CSVs and database exports, then draws out trends, anomalies and charts.\nIts real trademark is how it thinks. It doesn't just spit out a number: it generates code, runs it, checks its results, fixes its mistakes and starts again until it has a reliable answer. A virtual data scientist available around the clock, who never sighs when you change your mind.\nWe mostly hand it three big families of missions:\n➞ Integrate and clean data scattered across several files.\n➞ Analyze in depth to inform a decision.\n➞ Tell the story of the numbers with clear charts.",
        "The setting: welcome to Nova Sports\nFor the demo, picture Nova Sports, a French sports-gear online retailer. Like in real life, its Q1 2026 sales don't fit in one neat file.\nThey're split across two exports, one per region, collected by hand: Ventes_Nord_T1 and Ventes_Sud_T1. And of course the two aren't identical: in the Sud one, dates are written as text, an extra « Code_Promo » column hangs around, and some satisfaction scores are empty. The daily reality of any team.\nPut end to end, these two files represent 337 orders and 44,079 € in revenue.",
        "Tip #1: merge two files with a simple hello\nThe first useful reflex is to stop copying columns by hand. You load both files into Copilot, open the Analyst agent and kindly ask it to tidy up (see the prompt below).\nWhat happens next is quiet magic. Analyst aligns the columns, including « Code_Promo » that only exists on one side, converts text dates into real dates, cleans up « Sud » and spots the missing satisfaction scores. It hands you a single, clean, ready-to-use file. Twenty minutes of copy-paste settled in one sentence.",
        "Tip #2: ask THE question that hurts\nThis is where Analyst stops being a « nice macro » and becomes a real decision copilot. At Nova Sports, the marketing team has an idea that seems obvious: Running is the #1 category by revenue (13,129 €), so why not boost sales with a 15% discount? Cheaper, so more volume, so more revenue... right?\nAnalyst goes back to the real data. Average price of a Running item: 95.13 €, cost 59.03 €, so 36.10 € margin per unit. Cutting the price by 15% drops it to 80.86 €, but the cost doesn't move: margin per item collapses to 21.83 €.\nThe conclusion is merciless: just to hold the margin, you'd need to sell 65% more volume. And an already optimistic 30% increase? It would lose about 1,065 € of margin over the quarter. The obvious promo is a margin trap, and Analyst explains it step by step, without jargon.",
        "And what about the chart?\nA final strength: visual storytelling. Simply ask « make me a chart of margin by category and region, then summarize the three takeaways », and Analyst produces the visual and its commentary. From raw data to a steering-committee slide, without leaving the conversation.",
        "The right reflex for a dashboard\nA tip to go further: if what you need is a real Excel dashboard (KPIs, filters, charts wired to your data), don't ask Analyst, use « Edit with Copilot » directly in Excel.\nThe logic: Analyst is unbeatable for analyzing, answering a « what if... ? » question and producing a one-off chart. But to build a living dashboard inside the workbook, Excel's « Edit with Copilot » experience works natively on your file and leaves you a dashboard you can directly use and edit. The right tool for the right deliverable.",
        "What to remember\nThree simple ideas:\n➞ You speak plainly, Analyst does the math.\n➞ It doesn't guess: it reasons, runs code and checks its results.\n➞ It shines on « what if... ? » questions, where intuition gets it wrong.\nAnd for a dashboard, keep the « Edit with Copilot » in Excel reflex.",
      ],
    },
    stepImages: [
      null,
    ...
    info: {
      fr: "Analyst nécessite une licence Microsoft 365 Copilot. La licence inclut 25 requêtes par mois partagées entre Analyst et Researcher. Il s'appuie sur un modèle de raisonnement OpenAI et exécute du code Python. Disponible sur l'app Copilot (web et mobile). Pour un tableau de bord Excel, préférez « Edit with Copilot » dans Excel.",
      en: "Analyst requires a Microsoft 365 Copilot license. The license includes 25 queries per month shared between Analyst and Researcher. It relies on an OpenAI reasoning model and runs Python code. Available on the Copilot app (web and mobile). For an Excel dashboard, prefer « Edit with Copilot » in Excel.",
    },
    prompt: {
