...
export const tips: Tip[] = [
  ...
  },
  {
    ...
    summary: {
      fr: "Le vrai super-pouvoir de Cowork, c'est de tenir une mission récurrente à votre place. Voici un prompt prêt à planifier qui, chaque mois, va lire l'article « What's New in Microsoft 365 Copilot » sur le Microsoft Community Hub, en produit un résumé structuré, puis l'envoie par email dans une belle mise en page chartée — et le publie dans vos canaux Teams.",
      en: "Cowork's real superpower is running a recurring mission for you. Here's a ready-to-schedule prompt that, every month, reads the « What's New in Microsoft 365 Copilot » article on the Microsoft Community Hub, produces a structured summary, then emails it in a nicely branded layout — and posts it to your Teams channels.",
    },
    steps: {
      fr: [
        "L'idée : déléguer une veille récurrente\nTout le monde veut « rester à jour » sur les nouveautés Copilot, mais personne n'a le temps de lire le blog chaque mois, de trier, de résumer et de diffuser. C'est exactement le genre de mission répétitive et à étapes que Cowork sait tenir tout seul.\nLe principe : vous écrivez le prompt UNE fois, vous le planifiez pour qu'il s'exécute tous les mois, et Cowork fait le travail — vérifier, résumer, mettre en forme, envoyer. Vous ne touchez plus à rien.",
        "Ce que le prompt demande à Cowork\nLe prompt (à copier plus bas) décrit une mission complète et cadrée :\n➞ Aller sur le blog Microsoft 365 Copilot du Microsoft Community Hub.\n➞ Vérifier si l'édition récapitulative du mois en cours — « What's New in Microsoft 365 Copilot | [Mois] [Année] » — est publiée (elles sortent en fin de mois).\n➞ Ne surtout pas confondre avec une annonce de fonctionnalité isolée ou un article Copilot Studio.\n➞ Si l'édition du mois est déjà diffusée, s'arrêter ; si elle n'est pas encore publiée, ne rien envoyer et réessayer à la prochaine exécution.",
        "Un résumé structuré, reformulé\nQuand l'article est disponible, Cowork récupère tout le contenu, l'analyse et en produit un résumé concis en anglais — reformulé avec ses propres mots, jamais copié mot pour mot.\nLe résumé est rangé en deux familles, ce qui le rend directement exploitable :\n➞ User Capabilities — les nouveautés pour les utilisateurs métiers.\n➞ IT Admin Capabilities — ce qui concerne l'IT, la sécurité, la conformité et la gouvernance.\nChaque ligne suit le même format court : **Nom :** description en une phrase.",
        "La diffusion : un email HTML charté\nC'est là que Cowork brille : il ne se contente pas de résumer, il met en forme. Il génère un email HTML professionnel, compatible avec les principaux clients de messagerie, aux couleurs de votre organisation.\nEn-tête avec bandeau or, titre « What's New in Microsoft 365 Copilot » et sous-titre « Édition [Mois] [Année] », une phrase d'intro, puis les deux sections (User / IT Admin), un bouton « Read the full [Month] [Year] update → » qui pointe vers l'article source, et un pied de page avec le lien, le rédacteur et l'organisation.\nCi-dessous, le rendu réel obtenu pour l'édition de juin 2026.",
        "Et aussi dans Teams\nLe même résumé est publié dans deux espaces Teams pour toucher vos relais :\n➞ Le canal « Microsoft 365 Copilot News » de l'équipe « Digital Workplace » (format texte suffisant).\n➞ La conversation de groupe « Copilot Champions Network » — Cowork la retrouve automatiquement par son nom avant de publier.\nUn seul prompt, trois canaux : mail pour la diffusion large, Teams pour vos communautés.",
        "La gestion des doublons + la planification\nPour ne jamais envoyer deux fois la même édition, le prompt demande à Cowork d'enregistrer le mois et l'année une fois la diffusion réussie, puis de reprendre la surveillance pour l'édition suivante.\nCôté planification : lancez la mission une première fois pour valider le rendu, puis planifiez son exécution récurrente (par exemple tous les derniers jours du mois). Comme les éditions sortent en fin de mois, Cowork tombera pile au bon moment — et s'il ne trouve rien, il attendra simplement la prochaine exécution.",
    ...
    imageCaptions: [
      { step: 3, text: { fr: "Le rendu réel généré par Cowork : l'email HTML charté de l'édition de juin 2026, prêt à envoyer.", en: "The actual rendering generated by Cowork: the branded HTML email for the June 2026 edition, ready to send." } },
      { step: 5, text: { fr: "La mission planifiée dans Cowork : exécution mensuelle récurrente, instructions détaillées, et le fichier de sortie retrouvé dans le Workspace.", en: "The scheduled mission in Cowork: recurring monthly run, detailed instructions, and the output file found in the Workspace." } },
    ],
    info: {
