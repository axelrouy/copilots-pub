...
export const tips: Tip[] = [
  {
    ...
    steps: {
      fr: [
        ...
        "Créer une mémoire en langage naturel\nLe plus simple : dites-le à Copilot directement. Par exemple :\n➞ « Souviens-toi que je travaille principalement avec des interlocuteurs basés aux États-Unis. »\n➞ « Souviens-toi que je prépare souvent des résumés exécutifs et des one-pagers. »\n➞ « Souviens-toi d'utiliser la terminologie financière américaine. »\nCopilot confirme avec un « Memory updated » et applique la consigne. Sur la capture, il retient la préférence pour la terminologie financière US et détaille même le vocabulaire qu'il utilisera (Revenue plutôt que chiffre d'affaires, EBITDA conservé tel quel…). Vous gérez et supprimez ces mémoires à tout moment via « Manage saved memories ».",
      ...
      en: [
        ...
        "Creating a memory in natural language\nThe simplest way: just tell Copilot directly. For example:\n➞ « Remember that I mainly work with US-based counterparts. »\n➞ « Remember that I often prepare executive summaries and one-pagers. »\n➞ « Remember to use US financial terminology. »\nCopilot confirms with a « Memory updated » and applies the instruction. In the screenshot, it keeps the preference for US financial terminology and even details the vocabulary it will use (Revenue rather than chiffre d'affaires, EBITDA kept as is…). You manage and delete these memories anytime via « Manage saved memories ».",
