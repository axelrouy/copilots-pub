  ...
  },
  {
    ...
    steps: {
      fr: [
        ...
        "Première façon de l'activer : l'accès rapide en réunion\nLa méthode la plus simple se fait une fois la réunion démarrée. Dans les commandes de réunion, ouvrez « More actions » (les trois points), puis « Turn on Facilitator ». S'il n'y a pas encore de langue définie, Teams vous demande de choisir la langue parlée de la réunion.\nUn bandeau « Facilitator is on for this meeting » confirme alors qu'il est actif (avec un lien « Turn off » pour le couper). Bon à savoir : seuls l'organisateur et les présentateurs peuvent l'activer ou le désactiver.",
        "Deuxième façon : dans les options de réunion\nVous pouvez aussi l'activer en amont, à la planification. Ouvrez les options de la réunion, allez dans la section « Copilot and other AI », vérifiez que « Allow Copilot and Facilitator » est bien positionné, puis activez le bouton « Facilitator ». Choisissez la langue parlée, et validez.\nLes deux méthodes font exactement la même chose : elles activent Facilitator, qui lance automatiquement la transcription en début de réunion. C'est ce transcript qui lui permet ensuite de prendre des notes et de suivre la discussion.",
        ...
        "La nuance à connaître : transcription automatique n'est pas Facilitator\nDans les options de réunion, une autre section existe : « Recording & transcription », avec le réglage « Record and transcribe automatically » (Record and transcribe, Transcribe only, ou Off). Activez-le et l'enregistrement et/ou la transcription démarrent tout seuls au début de la réunion.\nAttention : ce réglage n'active pas l'agent Facilitator. Il permet simplement d'avoir un transcript, donc de pouvoir utiliser Copilot dans la réunion (au minimum grâce à ce transcript). Autrement dit : transcription automatique = Copilot exploitable en réunion ; Facilitator = un agent en plus qui prend les notes et anime, avec son propre bouton.",
      ...
      en: [
        ...
        "First way to turn it on: quick access in the meeting\nThe simplest method happens once the meeting has started. In the meeting controls, open « More actions » (the three dots), then « Turn on Facilitator ». If no language is set yet, Teams asks you to pick the meeting's spoken language.\nA « Facilitator is on for this meeting » banner then confirms it's active (with a « Turn off » link to stop it). Good to know: only the organizer and presenters can turn it on or off.",
        "Second way: in the meeting options\nYou can also turn it on ahead of time, when scheduling. Open the meeting options, go to the « Copilot and other AI » section, check that « Allow Copilot and Facilitator » is set correctly, then flip the « Facilitator » toggle. Pick the spoken language and apply.\nBoth methods do exactly the same thing: they turn on Facilitator, which automatically starts transcription at the beginning of the meeting. That transcript is what then lets it take notes and follow the discussion.",
        ...
        "The nuance to know: automatic transcription isn't Facilitator\nIn the meeting options, another section exists: « Recording & transcription », with the « Record and transcribe automatically » setting (Record and transcribe, Transcribe only, or Off). Turn it on and recording and/or transcription start on their own at the beginning of the meeting.\nCareful: this setting does not turn on the Facilitator agent. It simply gives you a transcript, so you can use Copilot in the meeting (at least thanks to that transcript). In other words: automatic transcription = Copilot usable in the meeting; Facilitator = an extra agent that takes notes and hosts, with its own toggle.",
    ...
    stepImages: [
      ...
      "/articles/facilitator-banner.png",
